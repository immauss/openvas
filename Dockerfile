...
COPY update.ts /
RUN wget https://www.immauss.com/openvas/base.sql.xz -O /usr/lib/base.sql.xz && \
    wget https://www.immauss.com/openvas/var-lib.tar.xz -O /usr/lib/var-lib.tar.xz
